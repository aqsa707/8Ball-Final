...
function clickAnswer() {
  ...
  } else if (inputE1.value === "Is JavaScript awesome?") {
    answerE1.innerHTML = "Yes, Of Course!";
  } else if (inputE1.value === "are you watching me?") {
    answerE1.innerHTML = "Noooo. Silly You!";
  } else if (randNum < 1) {
